...
<html lang="en">
    <head>
        ...
        <title>Closed Appointments - Admin View</title>
    ...
    <body>
        ...
        <div class="content" style="margin-top:100px;">
            <div class="table-container table-responsive">
                <h2 style="color:#624aa1;font-weight:bold;">Closed Appointments</h2>
                <table>
                    <thead>
                        <tr>
                        ...
                        <%
                            ...
                            try {
                                ...
                                String sql = "SELECT  appointment_date, child_name, hospital, hospital_branch, vaccine, parent_email "
                                        + "FROM book_appointments WHERE LOWER(status) = 'completed'"
