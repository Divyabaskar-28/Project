...
<html lang="en">
    <head>
        ...
        <title>Delayed Appointment</title>
    ...
    <body>
        ...
        <div class="content" style="margin-top:100px;">
            <div class="table-container table-responsive">
                <h2 style="color:#624aa1; font-weight: bold; text-align:center;">Delayed Appointments</h2>
                <table>
                    <thead>
                        <tr>
                        ...
                        <%
                            ...
                            try {
                                ...
                                String sql = "SELECT b.appointment_date, b.child_name, b.vaccine, b.parent_email "
                                        ...
                                        + "AND LOWER(b.status) = 'incompleted' "
                            ...
                            <div class="modal-content" style="background: linear-gradient(to right, #a18cd1, #fbc2eb); font-weight: bold;width:600px;">
                                ...
                                <div class="modal-body row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <img src="<%= profilePhoto%>" class="img-thumbnail rounded-circle" alt="Parent Photo" width="150" height="150">
                                    </div>
                                    <div class="col-md-8">
