    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <div class="border-box">
                <form name="vaccinationForm" action="UpdateVaccination.jsp" method="post" onsubmit="return validateForm()">
                    <%                        String vaccinationId = request.getParameter("id");
                        String url = "jdbc:mysql://localhost:3306/cvms";
                        String user = "root";
                        String pass = "";
                        Connection con = DriverManager.getConnection(url, user, pass);
                        PreparedStatement ps = con.prepareStatement("SELECT * FROM vaccination_schedule WHERE id = ?");
