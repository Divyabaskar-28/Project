        ...
        <div class="container mt-5">
            ...
            <%
                ...
                if (vaccinationId == null || vaccinationId.isEmpty() || age == null || age.isEmpty() || vaccinationName == null || vaccinationName.isEmpty() || dose == null || dose.isEmpty()) {
                    out.print("<script>alert('Please fill all the required fields.'); window.location.href='EditVaccination.jsp?id=" + vaccinationId + "';</script>");
                    return;
                }

                // SQL query to update vaccination details
                PreparedStatement ps = con.prepareStatement("UPDATE vaccination_schedule SET age=?, vaccination_name=?, dose=?, hospital_email=? WHERE id=?");
                ps.setString(1, age);
                ...
                if (result > 0) {
                    out.print("<script>window.location.href='Schedule.jsp';</script>");
                } else {
                    out.print("<script>alert('Failed to update vaccination details.'); window.location.href='EditVaccination.jsp?id=" + vaccinationId + "';</script>");
                }
