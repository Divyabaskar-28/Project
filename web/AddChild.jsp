    ...
    <body> 
        ...
        <%                 String url = "jdbc:mysql://localhost:3306/cvms";
            ...
            if (request.getParameter("cname") != null) {
                ...
                age = Integer.parseInt(request.getParameter("cage"));
                String blood = request.getParameter("cblood");
                float weight = Float.parseFloat(request.getParameter("cweight"));
                String father = request.getParameter("cfather");
                String mother = request.getParameter("cmother");

                PreparedStatement ps = con.prepareStatement("INSERT INTO child_details (name, dob, gender, age, blood_group, weight, father_name, mother_name) VALUES( ?,  ?,  ?,  ?,  ?,  ?,  ?,  ?)");
                ps.setString(1, name);
            ...
            if (request.getParameter("deleteId") != null) {
                ...
                PreparedStatement ps = con.prepareStatement("DELETE FROM child_details WHERE id=?");
        ...
        <div id="AddForm" style="display:none">
            ...
            <div class="border-box">
                <form action="AddChild.jsp" method="post" onsubmit="return saveForm(event)">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" name="cage" id="age">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" name="cweight" id="child_weight" min="1" max="50">
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 text-center">
                            ...
                            <input type="button" value="Clear" class="btn"  style="background-color:#624aa1; color:white;border: none;" onclick="hideForm()">
                    ...
                    <table>
                        ...
                        <tbody id="childTableBody">
                            ...
                            <%
                                ...
                                ResultSet rs = stmt.executeQuery("SELECT * FROM child_details");
                                int i = 1;
                                while (rs.next()) {
                                    java.sql.Date rawDob = rs.getDate("dob");
                                    String formattedDob = "";
                                    if (rawDob != null) {
                                        java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("dd-MM-yyyy");
                                        formattedDob = sdf.format(rawDob);
                                    }
                            %>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Delete button -->
                                    <form method="post" action="AddChild.jsp" style="display:inline;">
